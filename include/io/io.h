...
public:
    ...
    size_t bytes_written(void) const { return buf_.bytes_out(); }
...
public:
    ...
    size_t bytes_read(void) const { return buf_.bytes_read(); }
...
private:
    ...
    public:
        ...
        size_t bytes_read(void) const { return bytes_read_; }
...
//    rdc::serializer::Handler<T>::Write(this, data);
//}
//
//template <typename T>
//bool Stream::Read(T *out_data) {
//    return rdc::serializer::Handler<T>::Read(this, out_data);
//}
